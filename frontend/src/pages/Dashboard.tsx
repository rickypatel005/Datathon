...
export function Dashboard() {
  ...
  const datasetName = "Customer_Sales_Data";
  const analyzedDate = "07 Sep 2026, 01:24 PM";

  // Data Quality Metrics
  const qualityScore = 94.8;
  const radius = 52;
  const circumference = 2 * Math.PI * radius;
  const strokeDashoffset = circumference - (qualityScore / 100) * circumference;

  // Column Information from image
  const columnsData = [
  ...
  const filteredColumns = columnsData.filter(col =>
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16 animate-in fade-in duration-200">
      ...
      {/* Horizontal Tab Navigation Bar (Screen 3) */}
        ...
        <div className="space-y-7 animate-in fade-in duration-200">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
            <div className="bg-[#0e1629] border border-[#1e293b] rounded-2xl p-4 flex items-center gap-3.5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-white tracking-tight">12,482</h3>
            ...
            <div className="bg-[#0e1629] border border-[#1e293b] rounded-2xl p-4 flex items-center gap-3.5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-white tracking-tight">18</h3>
            ...
            <div className="bg-[#0e1629] border border-[#1e293b] rounded-2xl p-4 flex items-center gap-3.5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-white tracking-tight">94.8%</h3>
            ...
            <div className="bg-[#0e1629] border border-[#1e293b] rounded-2xl p-4 flex items-center gap-3.5 shadow-sm">
              ...
              <div>
                <h3 className="text-2xl font-black text-white tracking-tight">8.4s</h3>
                <p className="text-xs text-slate-400 mt-0.5">Analysis Time</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
              ...
              {/* Insight 4: Customer age & frequency */}
      ...
      {/* ─────────────────────────────────────────────────────────────
          TAB 2: VISUALIZATIONS / DATA PATTERNS (Screen 4)
         ───────────────────────────────────────────────────────────── */}
      {activeTab === 'visualizations' && (
        <div className="space-y-5 animate-in fade-in duration-200">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              <h2 className="text-xl font-bold text-white tracking-tight">Data Patterns</h2>
              <p className="text-xs text-slate-400">Automatically generated visualizations based on your dataset.</p>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xs text-slate-400 font-mono px-3 py-1.5 rounded-lg bg-[#0e1629] border border-[#1e293b]">
                All Visualizations (4)
              </span>
            </div>
          </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
          TAB 3: DATA QUALITY (Screen 5)
         ───────────────────────────────────────────────────────────── */}
      {activeTab === 'quality' && (
        <div className="space-y-6 animate-in fade-in duration-200">
          <div>
            <h2 className="text-xl font-bold text-white tracking-tight">Data Quality</h2>
            <p className="text-xs text-slate-400">AIDA automatically cleans your data for accurate insights.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 bg-[#0e1629] border border-[#1e293b] rounded-2xl p-6 flex flex-col items-center justify-center text-center space-y-4 shadow-sm">
              <div className="relative w-40 h-40 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-wider mt-0.5">Healthy</span>
                </div>
              </div>
              <p className="text-xs text-slate-400">Overall data integrity score based on nulls, distributions, and schema fidelity.</p>
            </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-3.5">
              <div className="bg-[#0e1629] border border-[#1e293b] p-4 rounded-xl">
                ...
                <p className="text-2xl font-bold text-white mt-1.5">12,482</p>
              </div>
              ...
              <div className="bg-[#0e1629] border border-[#1e293b] p-4 rounded-xl">
                ...
                <p className="text-2xl font-bold text-white mt-1.5">18</p>
              </div>
              ...
              <div className="bg-[#0e1629] border border-[#1e293b] p-4 rounded-xl">
                ...
                <p className="text-2xl font-bold text-amber-400 mt-1.5">127</p>
              </div>
              ...
              <div className="bg-[#0e1629] border border-[#1e293b] p-4 rounded-xl">
                ...
                <p className="text-2xl font-bold text-white mt-1.5">34</p>
              </div>
              ...
              <div className="bg-[#0e1629] border border-[#1e293b] p-4 rounded-xl">
                ...
                <p className="text-2xl font-bold text-red-400 mt-1.5">82</p>
              </div>
            </div>
          </div>

          {/* Cleaning Completed Box (Screen 5 bottom) */}
          <div className="bg-[#0e1629] border border-[#1e293b] rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm">
            <div>
              <h3 className="text-sm font-bold text-white mb-3">Cleaning Completed</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                ...
                <div className="flex items-center gap-2 text-slate-300">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                  <span>Formatting issues normalized</span>
                </div>
                <div className="flex items-center gap-2 text-slate-300">
                  <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                  <span>Column types automatically detected</span>
                </div>
              </div>
            </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
          TAB 4: DATASET DETAILS / DATASET OVERVIEW (Screen 6)
         ───────────────────────────────────────────────────────────── */}
      {activeTab === 'details' && (
        <div className="space-y-5 animate-in fade-in duration-200">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-400">Here's what we found in your dataset.</p>
            </div>
          ...
          {/* Subtabs: Column Information | Sample Data | Distributions */}
          <div className="flex items-center gap-2 border-b border-[#1e293b] pb-1 text-xs">
            ...
            <button
              onClick={() => setDetailsSubTab('distributions')}
              className={clsx(
                "px-3 py-1.5 rounded-lg font-medium transition-colors",
                detailsSubTab === 'distributions'
                  ? "bg-[#171f38] text-indigo-300 font-bold border border-indigo-500/30"
                  : "text-slate-400 hover:text-white"
              )}
            >
          ...
          {/* Column Information Table (Screen 6) */}
          <div className="bg-[#0e1629] border border-[#1e293b] rounded-2xl overflow-hidden shadow-sm">
            ...
            {/* Pagination Controls */}
            <div className="flex items-center justify-end gap-2 p-3 border-t border-[#1e293b] text-xs text-slate-400">
              <button className="px-2 py-1 rounded bg-[#131d38] text-slate-400 hover:text-white">&lt;</button>
              <button className="px-2 py-1 rounded bg-[#6366f1] text-white font-bold">1</button>
              <button className="px-2 py-1 rounded hover:bg-[#131d38]">2</button>
              <button className="px-2 py-1 rounded hover:bg-[#131d38]">3</button>
              <button className="px-2 py-1 rounded hover:bg-[#131d38]">4</button>
              <button className="px-2 py-1 rounded hover:bg-[#131d38]">5</button>
              <button className="px-2 py-1 rounded bg-[#131d38] text-slate-400 hover:text-white">&gt;</button>
            </div>
          </div>
        </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
          TAB 5: ADVANCED ANALYSIS (Screen 7)
         ───────────────────────────────────────────────────────────── */}
      {activeTab === 'advanced' && (
        <div className="space-y-6 animate-in fade-in duration-200">
          <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-[#0e1629] border border-[#1e293b] hover:border-sky-500/50 p-5 rounded-2xl shadow-sm space-y-3 transition-all">
              ...
              <h3 className="font-bold text-sm text-white">Clustering</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
                Applies unsupervised K-Means and HDBSCAN to segment observations into natural cohorts.
              </p>
              <div className="pt-2">
            ...
            <div className="bg-[#0e1629] border border-[#1e293b] hover:border-red-500/50 p-5 rounded-2xl shadow-sm space-y-3 transition-all">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Uses Isolation Forest and IQR interquartile filtering to flag anomalous spikes.
              </p>
              <div className="pt-2">
                <span className="text-[10px] font-mono font-semibold px-2 py-0.5 rounded bg-red-500/10 text-red-300">
                  82 Anomalies Flagged
                </span>
              </div>
            </div>
            ...
            <div className="bg-[#0e1629] border border-[#1e293b] hover:border-emerald-500/50 p-5 rounded-2xl shadow-sm space-y-3 transition-all">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Calculates SHAP attribution values for top drivers influencing the target outcome.
              </p>
              <div className="pt-2">
          ...
          <div className="bg-[#0b1326] border border-[#1e293b] rounded-2xl w-full max-w-lg p-6 shadow-2xl space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-300">
              <div className="p-3 rounded-xl bg-[#0e1629] border border-[#1e293b] space-y-1">
                ...
                <p className="text-slate-400">127 missing entries in product categories and prices imputed using median and domain heuristics.</p>
              </div>
              <div className="p-3 rounded-xl bg-[#0e1629] border border-[#1e293b] space-y-1">
                <p className="font-semibold text-emerald-400">Deduplication</p>
                <p className="text-slate-400">34 exact duplicate transaction records identified by compound key and pruned.</p>
              </div>
              <div className="p-3 rounded-xl bg-[#0e1629] border border-[#1e293b] space-y-1">
                <p className="font-semibold text-emerald-400">Normalization & Formatting</p>
                <p className="text-slate-400">ISO-8601 dates harmonized across columns; strings trimmed and lowercased.</p>
              </div>
            </div>
